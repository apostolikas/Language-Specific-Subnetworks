...
def stitch_across_languages(model_name, lang1, lang2, layer):
    if lang1 == lang2:
        return
...
def stitch_across_tasks(model_name1, model_name2, lang, layer):
...
def stitch_validation(model_name, layer, lang):
    dataset = Path(model_name).parent.stem
