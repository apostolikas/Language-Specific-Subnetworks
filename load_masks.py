...
def plot_matrix(matrix, x_labels, y_labels, save_path, x_title, y_title, colour_map=plt.cm.OrRd):
...
def surviving_per_task(masks_dict):
    ...
    for lang in LANGUAGES:
        ...
        plot_matrix(overlap_lang, TASKS, TASKS, f'super_survivors_{lang}', 'TASK', 'TASK')
